  ...
  return (
    <main className={styles.container}>
      <div className={styles.content}>
        ...
        <h2 className="mb-soft">Wedding on Long Island</h2>
        <p className="mb-regular">
          On the last Saturday in August, 1945, Miss Constanzia Corleone,
          daughter of Don Vito Corleone, married Carlo Rizzi. Her father had
          invited hundreds of people to the wedding at his huge house on Long
        ...
        <p className="mb-regular">
          ...
          uncomfortable in his white shirt and black suit. The second son,
          Fredo, was completely different. He was weak-looking and pale, with
          sad dark eyes and thin lips.
        </p>
        <h3 className="mb-soft">When Winter Comes</h3>
        <p className="mb-regular">
          Mario Puzo was born in New York in 1920. He has written many books but
          The Godfather, which he wrote in 1969, is his most famous. In 1972, it
        ...
        <h4 className="mb-soft">How snowflakes are made</h4>
        <p className="mb-regular">
          On the last Saturday in August, 1945, Miss Constanzia Corleone,
          daughter of Don Vito Corleone, married Carlo Rizzi. Her father had
          invited hundreds of people to the wedding at his huge house on Long
